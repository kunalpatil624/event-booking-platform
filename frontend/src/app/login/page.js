            ...
            >
                ...
                <div className="p-12 px-10 max-md:p-9 max-md:px-6 flex flex-col justify-center">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-3.5 mb-5">
                        ...
                        {isLogin && (
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="/forgot-password" className="text-[0.825rem] text-primary-light font-medium">Forgot password?</Link>
                            </div>
                        )}
                        ...
                        <button type="button" className="flex items-center justify-center gap-2.5 w-full py-3 bg-white/5 border border-border-default rounded-xl text-text-primary text-sm font-medium hover:bg-white/10 hover:border-border-light transition-all duration-300">
                    ...
                    <p className="text-center text-text-secondary text-sm">
                        ...
                        <button className="bg-none border-none text-primary-light font-semibold cursor-pointer text-sm" onClick={() => setIsLogin(!isLogin)}>
                            {isLogin ? 'Sign Up' : 'Login'}
                        </button>
                    </p>

                    <div className="flex items-center gap-3 text-text-muted text-xs mt-4">
                        <div className="flex-1 h-px bg-border-default" />
                        <span>other portals</span>
                        <div className="flex-1 h-px bg-border-default" />
                    </div>
                    <div className="flex gap-3 justify-center mt-2">
                        <Link href="/vendor" className="text-accent-emerald text-sm font-medium">🏢 Venue Owner Login</Link>
                        <Link href="/admin" className="text-red-500 text-sm font-medium">🛡️ Admin Login</Link>
                    </div>
                </div>
            </motion.div>
        </div>
