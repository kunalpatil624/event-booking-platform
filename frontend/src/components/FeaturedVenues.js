            ...
            <div className="container">
                <div className={styles.header}>
                    <div>
                        ...
                        <h2 className={styles.title}>Featured Venues</h2>
                        <p className={styles.desc}>Handpicked premium venues loved by thousands of happy customers</p>
                    </div>
                    <Link href="/venues?featured=true" className="btn btn-secondary">
