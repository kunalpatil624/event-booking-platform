            ...
            <div className="max-w-[1280px] mx-auto px-6">
                ...
                <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-6">
                    {testimonials.map((t, i) => (
                        <motion.div
                            key={i}
                            className="p-7 bg-bg-card border border-border-default rounded-2xl transition-all duration-300 hover:border-primary/25 hover:-translate-y-1 hover:shadow-[0_4px_16px_rgba(0,0,0,0.4)]"
